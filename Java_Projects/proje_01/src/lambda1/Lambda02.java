...
public static void toplaEl1(List<Integer> list) {
    ...
    public static void min4(List<Integer> list) {
        ...
        System.out.println(min);
        // icer4deki sarti ister expression ile ister method ile yazilabilir
    }
// Listeki 15 den buyuk en kucuk tek sayiy yazdiriniz
    public static void onbestenbuyukenkucuktek(List<Integer> list) {
        System.out.println(list.stream().filter(t -> t % 2 != 0 & t > 15).reduce(Integer::min));
