...
public class Not_Hesaplama_OK {
	...
	public static void main(String[] args) {
        ...
        7. Vize gecme ortalamasını bulmak için, vize nin yüzde40 ı, finalin yüzde60 ı alınmalı ve çıkan sonuçlar toplanmalıdır.
    	...
    	System.out.println("lutfen sinav sonucunuzu giriniz...");
    	double vize = scan.nextDouble();
    	
        System.out.println("sinav sonuc yuzdeniniz giriniz...");
        
        double vize_yuzdesi = scan.nextDouble();
        
        System.out.println("lutfen finalsonucunuzu giriniz...");
    	double fnl = scan.nextDouble();
    	
        System.out.println("final yuzdeniniz giriniz...");
    	...
    	if (ortalama>=90) {
    		System.out.println("sinav sonucunuz AA "+ortalama);
    	}
    	else if (ortalama>=80) {
    		System.out.println("sinav sonucunuz BA "+ortalama);
    	
    	}
    	else if (ortalama>=70) {
    		System.out.println("sinav sonucunuz BB "+ortalama);
    	
    	}
    	else if (ortalama>=60) {
    		System.out.println("sinav sonucunuz CB "+ortalama);
	    ...
	    System.out.println("sinav sonucunuz CB "+ortalama);
    	    ...
    	    System.out.println("sinav sonucunuz DC "+ortalama);
            }
        else if (ortalama>=30) {
    	    System.out.println("sinav sonucunuz DD "+ortalama);
            }
    	scan.close();	
